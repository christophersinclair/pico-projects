...
#define GPIO_CTRL_OFFSET 0x04 // 32-bit (4 byte) wide registers
#define GPIO_CTRL_REGISTER_OFFSET 0x08 // difference between GPIO registers is 8 bytes
...
#define GPIO_CTRL(pin) (GPIO_BASE + GPIO_CTRL_OFFSET + (pin) * GPIO_CTRL_REGISTER_OFFSET)
